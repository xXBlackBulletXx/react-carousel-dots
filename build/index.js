  ...
  function ReactCarouselDots(props) {
    ...
    _this.getHolderStyle = function () {
      ...
      if (_this.state.direction === 'forwards') {
        if (_this.props.active < _this.props.visible - 2) {
          style = _extends({}, style, {
            maxWidth: _this.props.size * _this.props.visible + _this.props.visible * _this.props.margin * 2
          });
        } else {
          style = _extends({}, style, {
            maxWidth: _this.props.size * (_this.props.visible + 1) + (_this.props.visible + 1) * _this.props.margin * 2
          });
        }
